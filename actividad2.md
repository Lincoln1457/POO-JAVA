...
La programación estructurasa se basa en **funciones** que se realizan en base a los datos que hayan, claramente se enfoca en **funciones**, los datos se administran por medio de variables **globales** o **locales** y los lenguales que suelen utilizar esta mecánica son **C**, **Pascal** y **Basic**.

## Programación orientada a objetos **(POO)**
Esta se da por medio de objetos que utilizan una combinación entre datos y **comportamientos** para su correcto funcionamiento que se organiza en clases y **objetos**, utilizan la **herencia**, el **poliformismo** para poder reutilizar datos dentro del sistema, los datos juegan dentro de objetos y sus lenguajes son **Java**, **Python**, **C++**, etc.
